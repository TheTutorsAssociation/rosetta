...
class TestUserFullName:
    def test_full_name_joins_first_and_last(self):
        ...
        user = User(first_name='Alice', last_name='Smith', email='alice@test.com', user_type='member')
    ...
    def test_full_name_omits_missing_first_name(self):
        ...
        user = User(first_name=None, last_name='Smith', email='smith@test.com', user_type='member')
